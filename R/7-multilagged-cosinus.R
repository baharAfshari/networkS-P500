...
for (year in years) {
  ...
  save_dir <- paste0("data/multilag/daily_cosinus_multilag3_", year, ".rda")
  save(daily_res_multilag, file = save_dir)
}



# load("data/multilag/daily_cosinus_multilag_2018.rda")
...
for (year in years) {
  ...
  dist_out <- paste0("data/multilag/multilags3_", year, ".rda")
